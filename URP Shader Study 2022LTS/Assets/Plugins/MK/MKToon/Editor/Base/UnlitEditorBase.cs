...
namespace MK.Toon.Editor
{
    ...
    internal abstract class UnlitEditorBase : ShaderGUI
    {
        ...
        protected MaterialProperty _cCMask;
        protected MaterialProperty _cUMask;
        protected MaterialProperty _cBMask;
        ...
        protected virtual void FindProperties(MaterialProperty[] props)
        {
            ...
            _cCMask = FindProperty(Properties.cCMask.uniform.name, props);
            _cBMask = FindProperty(Properties.cBMask.uniform.name, props);
        ...
        protected virtual void DrawDissolve(MaterialEditor materialEditor)
        {
            ...
            if(_dissolve.floatValue != (int)Dissolve.Off)
            {
                if(_dissolveMap.textureValue != null)
                    ...
                    materialEditor.TexturePropertySingleLine(UI.cCMask, _cCMask);
                    materialEditor.TexturePropertySingleLine(UI.cBMask, _cBMask);
                if(_dissolveMap.textureValue != null)
                {

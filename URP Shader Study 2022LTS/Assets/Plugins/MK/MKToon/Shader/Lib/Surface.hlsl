...
//////////////////////////////////////////////////////
	...
	)
	{
		...
		//dissolve could be moved above the screen uv to safe some instructions while clipping
			...
			#endif
			surfaceData.dissolveClip = SAMPLE_TEX2D_FLIPBOOK(_FirstMask, SAMPLER_REPEAT_MAIN, dissolveUV, SURFACE_FLIPBOOK_UV).r - _DissolveAmount;
			surfaceData.dissolveClip += SAMPLE_TEX2D_FLIPBOOK(_SecondMask, SAMPLER_REPEAT_MAIN, dissolveUV, SURFACE_FLIPBOOK_UV).r - _DissolveAmount;
			surfaceData.dissolveClip += SAMPLE_TEX2D_FLIPBOOK(_ThirdMask, SAMPLER_REPEAT_MAIN, dissolveUV, SURFACE_FLIPBOOK_UV).r - _DissolveAmount;

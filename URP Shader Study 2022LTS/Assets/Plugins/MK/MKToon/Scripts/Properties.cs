...
namespace MK.Toon
{
    public static class Properties
    {
        ...
        public static readonly TextureProperty cCMask                              = new TextureProperty(Uniforms.cCMask);
        public static readonly TextureProperty cBMask                              = new TextureProperty(Uniforms.cBMask);

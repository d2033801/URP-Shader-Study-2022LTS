...
namespace MK.Toon
{
    public static class Uniforms
    {
        ...
        public static readonly Uniform dissolveMap                      = new Uniform("_FirstMask");
        public static readonly Uniform cCMask                           = new Uniform("_SecondMask");
        public static readonly Uniform cBMask                           = new Uniform("_ThirdMask");
